...
faculty_to_building = {"SCI 1": ["M3", "B1", "AHS", "DWE"],
                       "SCI 2": ["M3", "DWE", "MC"],
                       "SCI 3": ["M3", "MC", "B1", "RCH", "HH"],
                       "MATH 1": ["MC", "B1", "RCH", "E2", "STP"],
                       "MATH 2": ["MC", "B1", "PHY", "RCH", "HH"],
                       "MATH 3": ["DWE", "E2", "MC", "EV3", "STC"],
                       "ENV 1": ["RCH", "EV3", "EV2"],
                       "ENV 2": ["M3", "STP", "DC", "EV3"],
                       "ENV 3": ["DC", "PHY", "RCH", "EV2", "M3"],
                       "ARTS 1": ["STP", "AL", "ML", "QNC"],
                       "ARTS 2": ["STP", "ML", "QNC", "PAC", "MC"],
                       "ARTS 3": ["STP", "HH", "DC", "RCH"],
                       "AHS 1": ["M3", "STC", "BMH", "AHS", "PAS"],
                       "AHS 2": ["AHS", "PAS", "STC", "OPT"],
                       "AHS 3": ["M3", "STC", "AHS"],
                       "ENG 1": ["RCH", "E7", "DWE"],
                       "ENG 2": ["MC", "RCH", "E7"],
                       "ENG 3": ["E7", "EIT", "CPH", "ML"]} 
